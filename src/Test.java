...
///////  for footballMatch
		...
		FootballMatch footballMatchIII = new FootballMatch(listTeam1, listTeam3, team3, 4, 3, dsWinMapIII);
////// for Award
...
/// test method
	...
	System.out.println(ketqua.static_PlayerTime());
	}
}
